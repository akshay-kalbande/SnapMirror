...
//         loaded: (userID, posts, message) =>
//             posts.fetchingMore || posts.isLastPage
//             ? null
//             : bloc.add(FollowingFeedEvent.fetchMore(userID)),
//       );
//     }
//   }
//
...
//               ],
//             ),
//       body: BlocBuilder<FollowingFeedBloc, FollowingFeedState>(
//         builder: (context, state) => state.map(
//           initial: (value) => const SizedBox.shrink(),
//           loading: (value) => const Center(child: CircularProgressIndicator()),
//           loaded: (value) => value.posts.items.isEmpty
//               ? Center(
//                   child: Text(
//                     (value.message?.isError ?? false)
//                         ? value.message!.content
//                         : 'something went wrong. Try again!',
//                   ),
//                 )
//               : AppPage(
//                   isLoading: value.posts.fetchingMore,
//                   child: ListView.builder(
//                     controller: _scrollController,
//                     cacheExtent: 1000,
//                     itemCount: value.posts.items.length,
//                     itemBuilder: (context, index) => Padding(
//                       key: ValueKey(value.posts.items[index]),
//                       padding: screenWidth >= webScreenSize
//                           ? EdgeInsets.symmetric(
//                               horizontal: screenWidth * 0.3,
//                               vertical: 20,
...
//                           postID: value.posts.items[index],
//                           postFeedSubscriptionUsecase:
//                               sl<GetPostFeedSubscriptionUsecase>(),
//                           getPostUsecase: sl<GetPostUsecase>(),
//                           togglePostUsecase: sl(),
